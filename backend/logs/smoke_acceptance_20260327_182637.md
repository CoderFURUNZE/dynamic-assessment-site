...
7. [PASS] admin /api/auth/me 结构
   - payload={'id': 1, 'username': 'admin', 'role': 'admin', 'active': True, 'full_name': '', 'student_no': '', 'class_name': '', 'phone': None}
8. [PASS] teacher 获取 /api/auth/me
   - status=200, expected=(200,)
9. [PASS] teacher /api/auth/me 结构
   - payload={'id': 2, 'username': 'teacher1', 'role': 'teacher', 'active': True, 'full_name': '', 'student_no': '', 'class_name': '', 'phone': None}
...
12. [FAIL] 教师课程管理列表 /api/admin/courses
   - status=403, expected=(200,)
